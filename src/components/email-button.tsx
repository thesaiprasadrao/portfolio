...
export const EmailButton: React.FC<EmailButtonProps> = ({ className, label = "Email", ...props }) => {
  return (
    <button
      aria-label={label}
      className={cn("email-btn", className)}
      type="button"
      {...props}
    >
      <span className="email-svg-wrapper">
        <svg
          ...
          viewBox="0 0 448 512"
          height="1.5em"
          xmlns="https://fonts.googleapis.com/css2?family=Material+Symbols+Outlined:opsz,wght,FILL,GRAD@20..48,100..700,0..1,-50..200&icon_names=mail"
          aria-hidden="true"
          focusable="false"
        >
